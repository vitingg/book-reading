...
export function UserProfile() {
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center h-screen bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-white gap-2">
        <div className="border border-gray-500 flex w-3/4 h-4/5 dark:bg-gray-800 rounded-3xl">
          <div className="w-2/5 flex flex-col items-center justify-center">
            <div className="border border-gray-500 flex flex-col items-center justify-center dark:bg-gray-800 rounded-2xl">
              ...
              <div className="flex flex-col justify-center ml-4 mr-4">
                <h2 className="mt-10 text-2xl">User Name: aaaaaaaa</h2>
                <h2 className="mt-2 text-2xl mb-8">User Role: aaaaa</h2>
              </div>
            </div>
          </div>
